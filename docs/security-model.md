...
- No local scanning outside `PATCHPILOT_LOCAL_ROOTS`.
...
- No validation install lifecycle scripts unless `PATCHPILOT_ALLOW_VALIDATION_SCRIPTS=true`.
...
- Workspace cleanup unless `PATCHPILOT_RETAIN_WORKSPACES=true`.
