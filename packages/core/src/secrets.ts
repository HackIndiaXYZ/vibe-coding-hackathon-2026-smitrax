 ...
 * secrets can be supplied via a JSON file pointed to by PATCHPILOT_SECRETS_FILE --
 ...
 */
export function loadSecretsFile(filePath = process.env.PATCHPILOT_SECRETS_FILE): { loaded: number; keys: string[] } {
