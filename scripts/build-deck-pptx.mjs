...
try {
  ...
  const SPEAKER_NOTES = [
    ...
    [
      "SLIDE 2 - Solution.",
      "",
      "Thesis: Codex writes the fix. PatchPilot's audited pipeline applies it. Only Codex (GPT-5.5) is permitted to mutate the repo - via the user's subscription, in a workspace-write sandbox.",
      "",
      ...
      "",
      "Non-Codex models only return strict-JSON plans; PatchPilot applies them. Raw secret findings are not sent to cloud models."
    ].join("\n"),
    [
    ...
    [
      ...
      "They don't read the dependency tree and can't maintain what they ship; PatchPilot is the safety net.",
      "",
