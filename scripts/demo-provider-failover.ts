...
import { JsonDatabase, PatchPilotService, classifyAgentRemediation, clearReadinessCache, updateSettings } from "../packages/core/src/index.ts";
...
async function main() {
  ...
  try {
    ...
    const project = await service.createProject({ sourceType: "local", localPath: fixture, name: "patchpilot-failover-demo" });
