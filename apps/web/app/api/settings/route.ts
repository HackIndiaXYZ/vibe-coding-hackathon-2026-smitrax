...
import { JsonDatabase, PatchPilotError, apiError, getSettings, updateSettings, type StoredSettings } from "@patchpilot/core";
...
export async function PATCH(request: NextRequest) {
  try {
    ...
    if (Object.keys(patch).length === 0) throw new PatchPilotError("no_valid_settings", "No recognized settings keys were provided.");
